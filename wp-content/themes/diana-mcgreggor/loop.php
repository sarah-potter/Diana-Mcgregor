...
<?php /* How to display all other posts. */ ?>
	...
	<?php endif; ?>
		...
		<div class="blog-entry-info">
			...
			<p class="comments-count-link">
			<span class="comments-link"><?php comments_popup_link( __( '0 Comments', 'coraline' ), __( '1 Comment', 'coraline' ), __( '% Comments', 'coraline' ) ); ?></span>
			
			
			<span class="leave-a-comment">
			<?php comments_popup_link( __( 'Leave a Comment', 'coraline' ), __( 'Leave a comment', 'coraline' ) ); ?></span>
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				<div id="nav-below" class="navigation">
					<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav"></span> << previous page', 'coraline' ) ); ?></div>
					<div class="nav-next"><?php previous_posts_link( __( 'next page >> <span class="meta-nav"></span>', 'coraline' ) ); ?></div>
				</div><!-- #nav-below -->
<?php endif; ?>